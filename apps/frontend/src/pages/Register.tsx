...
const Register = () => {
    ...
    return (
        <div className={`min-h-screen flex font-sans ${isDark ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-900"}`}>
            <Sidebar
                showRooms
            ...
            <div className="flex-1 flex items-center justify-center p-6 overflow-hidden lg:ml-64 relative">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-indigo-600/30 rounded-full blur-3xl animate-pulse pointer-events-none" />
